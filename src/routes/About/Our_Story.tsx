    ...
    return (
        <div className="bg-[#F5FAF6] md:px-20 px-10 md:py-30 py-15">
            ...
            <div className="flex flex-col md:flex-row gap-20">
                ...
                <div className="gap-y-8 md:px-10 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row pt-10 gap-20">
                <div className="gap-y-8 md:pr-10 flex flex-col items-center justify-center">
                    ...
                    <p className="hidden lg:block lg:text-[1.25rem] md:text-[1.125rem] text-[1rem]">At The Unsolicited Chosen, we act not for recognition but out of purpose. We believe cleaner, healthier communities don’t need to wait for perfect systems they need people who care. </p>
                    <p className="hidden lg:block lg:text-[1.25rem] md:text-[1.125rem] text-[1rem]">That’s why we go where the need is greatest, bringing practical solutions, compassion, and faith-driven service to underserved spaces in Nairobi and beyond. </p>
                </div>
