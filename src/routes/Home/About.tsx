...
const AboutSection = () => {
    ...
    return (
        <div className=" w-full flex bg-[#F5FAF6] gap-12 justify-center px-20 py-30">
            ...
            <div className="w-78 lg:h-100 bg-cover bg-center bg-no-repeat"
            ...
            <div>
                ...
                <p className="lg:text-lg  md:text-base text-sm md:w-100 lg:w-120 mb-10 text-[#384B38]">The Unsolicited Chosen is a Nairobi-based faith-inspired community initiative focused on environmental restoration, waste management, and public education. 
