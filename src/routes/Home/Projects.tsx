...
import children from "../../assets/images/children.jpg?w=1280"
...
const Projects = () =>{
    return (
        <div className="md:px-20 md:py-30 px-6 sm:px-10 py-15">
            <div className="flex flex-row  gap-4 md:justify-between pb-8 lg:pt-20 md:justify-items-stretch justify-center items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 auto-rows-min gap-8 md:gap-4">
                <div className="space-y-4 w-full h-auto">
                    <ScrollImageReveal>
                    <img className="w-full md:h-74.5 h-auto rounded-xl object-cover animate-zoom-out" src={veg} alt="" loading="lazy" decoding="async" />
                    </ScrollImageReveal>
                ...
                <div className="flex flex-col space-y-4 w-full h-auto">
                    <ScrollImageReveal>
                    <img className="w-full md:h-160 lg:h-191.5 rounded-xl object-cover animate-zoom-out" src={recyc} alt="" loading="lazy" decoding="async" />
                    </ScrollImageReveal>
                ...
                <div className="flex flex-col space-y-4 w-full h-auto lg:-mt-100">
                    <ScrollImageReveal>
                    <img className="w-full md:h-74.5 h-auto rounded-xl object-cover animate-zoom-out" src={children} alt="" loading="lazy" decoding="async" />
                    </ScrollImageReveal>
