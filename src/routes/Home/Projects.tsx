...
const Projects = () =>{
    return (
        <div className="px-20 py-30">
            ...
            <p className="italic font-bold pb-12 text-[#184E35] lg:text-lg  md:text-base text-sm">Transforming our communities, one action at a time.</p>
            <p className="lg:text-lg  md:text-base text-sm w-120.5 pb-20">From cleaning up public spaces to teaching sustainable waste practices and planting trees, our programmes are practical, people-powered, and built to scale.</p>
