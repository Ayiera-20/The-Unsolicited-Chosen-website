        ...
        <div className="px-20 py-30 bg-[#F5FAF6] ">
           ...
           <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                <div className="bg-[#384B38] w-full md:w-1/3 space-y-4 text-white px-10 py-6 text-[16px] h-131 max-h-131">
                    <p>Every great city breathes through its people, and Nairobi is no different. When you step in to help, you’re not just picking litter or planting trees; you're sowing seeds of dignity, health, and hope. </p>
