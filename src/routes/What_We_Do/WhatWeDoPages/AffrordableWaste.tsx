    ...
    return (
        <div>
            ...
            height="h-[70vh]"
             ...
             <div className="flex items-center justify-center gap-20 px-20 py-30">
                 ...
                 <div className="max-w-135 flex flex-col gap-8">
                    ...
                    <p className="text-lg">We work to make waste management simple, affordable, and accessible especially in underserved areas of Nairobi where formal waste collection is limited or nonexistent. By introducing color-coded bins, scheduled collections by Micro-Teams, and community-managed systems, we aim to ensure that everyone has a clean and safe environment, regardless of income.</p>
                    <p className="text-lg">We provide waste collection solutions in areas where residents cannot afford commercial services. </p>
                    <p className="text-lg">Our approach includes deploying Micro-Collection Teams to pick up waste at designated times and locations.</p>
                    <p className="text-lg"> We also install labeled bins (organic, recyclable, and others) to promote better waste management at the household level.</p>
                </div>
            ...
            <div className="px-20 py-30 flex flex-col items-center justify-center bg-[#F5FAF6]">
                <h2 className="text-[#184E35] text-[32px] pb-15">Tech-Enabled Waste Tracking</h2>
                <p className="lg:text-lg max-w-280 pb-8">Each collection point is equipped with QR codes to help our teams log collection data in real-time. This system allows us to track efficiency, detect neglected areas, and share transparent reports with partners and the community. These efforts ensure accountability and service quality at all times.</p>
                <p className="lg:text-lg max-w-280">Each collection point is equipped with QR codes to help our teams log collection data in real-time. This system allows us to track efficiency, detect neglected areas, and share transparent reports with partners and the community. These efforts ensure accountability and service quality at all times.</p>
